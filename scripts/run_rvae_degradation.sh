...
CONFIG="${CONFIG:-configs/data_aug/rvae_degradation_5feat.yaml}"
RUN_ID="rvae_degradation_5feat_$(date +%Y%m%d_%H%M%S)"
RUN_DIR="outputs/data_aug/degradation/rvae/${RUN_ID}"
mkdir -p "$RUN_DIR"
export RUN_DIR
