...
OUTPUT_SPECS = default_output_fields() + [
    ...
    {"chinese_name": "指标详情", "english_name": "metrics", "param_type": "dict", "desc": "测试指标（不含图片路径）"},
    {"chinese_name": "混淆矩阵图", "english_name": "confusion_matrix_png", "param_type": "str", "desc": "故障诊断混淆矩阵图片路径"},
]
